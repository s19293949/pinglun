...
class config():
    ...
    dropout_keep_prob=0.6      #dropout数量
    batch_size=64
    num_epochs=80
...
#加载数据
all_sample_lists,all_label_arrays,max_sentences_length=readdata.get_all_data_from_file(positive_file_path,negative_file_path,force_len=100)
all_sample_arrays=np.array(get_embedding_vector(all_sample_lists))
